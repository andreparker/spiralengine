...
class	TiXmlBase
{
	 ...
	 public:
			 ...
			 */
			virtual	void Print(FILE_INTERFACE	*cfile,	int	depth)const	=	0;
...
class	TiXmlAttribute:	public TiXmlBase
{
	 ...
	 public:
			...
			// Prints	this Attribute to	a	FILE_INTERFACE stream.
			virtual	void Print(FILE_INTERFACE	*cfile,	int	depth)const;
...
class	TiXmlElement:	public TiXmlNode
{
	 public:
			...
			// Print the Element to	a	FILE_INTERFACE stream.
			virtual	void Print(FILE_INTERFACE	*cfile,	int	depth)const;
...
class	TiXmlComment:	public TiXmlNode
{
	 public:
			...
			virtual	TiXmlNode	*Clone()const;
			///	Write	this Comment to	a	FILE_INTERFACE stream.
			virtual	void Print(FILE_INTERFACE	*cfile,	int	depth)const;
...
class	TiXmlText: public	TiXmlNode
{
	 ...
	 public:
			...
			///	Write	this text	object to	a	FILE_INTERFACE stream.
			virtual	void Print(FILE_INTERFACE	*cfile,	int	depth)const;
...
class	TiXmlDeclaration:	public TiXmlNode
{
	 public:
			...
			virtual	TiXmlNode	*Clone()const;
			///	Print	this declaration to	a	FILE_INTERFACE stream.
			virtual	void Print(FILE_INTERFACE	*cfile,	int	depth)const;
...
class	TiXmlUnknown:	public TiXmlNode
{
	 public:
			...
			virtual	TiXmlNode	*Clone()const;
			///	Print	this Unknown to	a	FILE_INTERFACE stream.
			virtual	void Print(FILE_INTERFACE	*cfile,	int	depth)const;
...
class	TiXmlDocument: public	TiXmlNode
{
	 public:
			...
			/**	Load a file	using	the	given	FILE_INTERFACE*. Returns true	if successful. Note	that this	method
			doesn't	stream - the entire	object pointed at	by the FILE_INTERFACE*
			will be	interpreted	as an	XML	file.	TinyXML	doesn't	stream in	XML	from the current
			file location. Streaming may be	added	in the future.
			 */
			bool LoadFile(FILE_INTERFACE *,	TiXmlEncoding	encoding = TIXML_DEFAULT_ENCODING);
			///	Save a file	using	the	given	FILE_INTERFACE*. Returns true	if successful.
			bool SaveFile(FILE_INTERFACE*)const;
			...
			///	Print	this Document	to a FILE_INTERFACE	stream.
			virtual	void Print(FILE_INTERFACE	*cfile,	int	depth	=	0)const;
			// [internal use]

...
/*
 * THIS	FILE WAS ALTERED BY	John W. Ratcliff on February 2, 2007
 *
 * - Put the source code in its own namespace and allowed it
 * - to optional parse XML files directly from memory.
 */

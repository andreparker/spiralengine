...
bool GuiList::AddItem( const std::string& item )
{
...
GuiList::GuiList( const Math::SpVector2r& position, const std::string itemList[], boost::uint32_t itemCount,
...
bool GuiList::GetItem( boost::uint32_t index, std::string& item )const
{
	bool result = false;
